    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-4" style="text-align: left;padding: 26px;padding-bottom: 17;padding-left: 74px;padding-right: 0px;border-color: var(--bs-card-bg);background: #f2f2f2;">
                <h1 style="font-size: 32px;"><strong>Virtual Account Credit&nbsp;</strong></h1>

                <p>Hi, {{$data1["first_name"]}}</p><br><br>

                <p> Hi, we like to infrom you that you have received  NGN{{ number_format($data1["amount"], 2) }}<br> to your Main Account</p>
